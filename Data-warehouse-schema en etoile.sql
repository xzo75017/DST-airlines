...
select DISTINCT F.FLIGHTID, F.DPAIRPORTCODE , DPSCHEDULEDDATE, DPSCHEDULEDTIME, DPACTUALDATE, DPACTUALTIME, DPSTATUSCODE, F.AIRLINEID, F.AIRCRAFTCODE , F.ARRAIRPORTCODE, ARRSCHEDULEDDATE, ARRSCHEDULEDTIME, ARRACTUALDATE, ARRACTUALTIME, ARRSTATUSCODE, f.STATUSCODE
